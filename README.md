...
1. If the appointment data grows to millions of records, how would you handle:
**ANSWER**:
...
2. In your opinion, is MongoDB suitable for this use case? Why or why not?
**ANSWER**:
...
1. An error occurs only in production but cannot be reproduced locally. What are your steps?
**ANSWER**:
...
2. How would you log and monitor appointment failures?
**ANSWER**:
...
3. If this API suddenly becomes slow, how would you investigate and mitigate the issue?
**ANSWER**:
Investigate:
...
1. How do you ensure a patient cannot book an appointment on behalf of another patient?
**ANSWER**:
...
2. How should secrets (API keys, database credentials) be handled?
**ANSWER**:
...
3. Is rate limiting necessary for this endpoint? Explain your reasoning.
**ANSWER**:
...
1. Do you use AI tools (e.g., GitHub Copilot, ChatGPT) in development?
**ANSWER**:
chatGPT, antigravity
2. Which parts of this task should not rely solely on AI‑generated code?
**ANSWER**:
